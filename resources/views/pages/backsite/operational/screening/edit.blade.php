        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Screening</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.screening.update', [$screening->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Screening</h4>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="blood_type_id" id="blood_type_id"
                                                            ...
                                                            <option value="{{ old('blood_type_id', isset($screening) ? $screening->blood_type_id : '') }}" disabled selected>{{ $screening->blood_type->name }}
                                                            </option>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="hiv" id="hiv" class="form-control select2"
                                                            required>
                                                            <option value="{{ old('hiv', isset($screening) ? $screening->hiv : '') }}" disabled selected>
                                                                @if ($screening->hiv == 1)
                                                                    <span>{{ 'Positif' }}</span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="hcv" id="hcv" class="form-control select2"
                                                            required>
                                                            <option value="{{ old('hcv', isset($screening) ? $screening->hcv : '') }}" disabled selected>
                                                                @if ($screening->hcv == 1)
                                                                    <span>{{ 'Positif' }}</span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="hbsag" id="hbsag" class="form-control select2"
                                                            required>
                                                            <option value="{{ old('hbsag', isset($screening) ? $screening->hbsag : '') }}" disabled selected>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="vdrl" id="vdrl" class="form-control select2"
                                                            required>
                                                            <option value="{{ old('vdrl', isset($screening) ? $screening->vdrl : '') }}" disabled selected>
                                                                @if ($screening->vdrl == 1)
                                                                    <span>{{ 'Positif' }}</span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="officer_id" id="officer_id"
                                                            class="form-control select2" required>
                                                            <option value="{{ old('officer_id', isset($screening) ? $screening->officer_id : '') }}" disabled selected>{{ $screening->officer->name }}
                                                            </option>
