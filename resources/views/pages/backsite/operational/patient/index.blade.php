        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Pasien</h3>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.patient.store') }}"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="no_mr" name="no_mr"
                                                                class="form-control col-md-3" value="{{ old('no_mr') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="birth_date">No MR Lahir
                                                            <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="diagnosis" name="diagnosis"
                                                                ...
                                                                autocomplete="off" placeholder="contoh. Anemia" required>
                                                ...
                                                <input type="hidden" name="last_mr_number" id="last_mr_number"
                                                    value="{{ $lastPatientId }}">
                                                <input type="hidden" name="no_mr_hidden" id="no_mr_hidden" value="">
                                                                ...
                                                                <td class="text-center">
                                                                    @can('patient_show')
                                                                        <a href="#mymodal"
                                                                            ...
                                                                            data-title="Patient Detail" class="badge badge-info"
                                                                    ...
                                                                    @endcan
                                                                    @can('patient_edit')
                                                                        <a href="{{ route('backsite.patient.edit', $patient_item->id) }}"
                                                                    ...
                                                                    @can('patient_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deletePatient({{ $patient_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
...
@push('after-script')
    ...
    <script>
        ...
        $(document).ready(function() {
            var noMrInput = $('#no_mr');
            var lastMrNumberInput = $('#last_mr_number');

            var lastPatientId = parseInt(lastMrNumberInput.val());
            var newMrNumber = lastPatientId + 1;
            var formattedMrNumber = 'MR' + newMrNumber.toString().padStart(5, '0');

            noMrInput.val(formattedMrNumber);
            lastMrNumberInput.val(newMrNumber);
            $('#no_mr_hidden').val(formattedMrNumber);
        });

        function deletePatient(patientId) {
            if (confirm('Anda yakin ingin menghapus data ini?')) {
                var form = document.createElement('form');
                form.action = '{{ route('backsite.patient.destroy', '__id') }}'.replace('__id', patientId);
                form.method = 'POST';
