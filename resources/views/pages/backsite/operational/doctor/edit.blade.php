                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.doctor.update", [$doctor->id]) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="example dentist or dermatology" value="{{ old('name', isset($doctor) ? $doctor->name : '') }}" autocomplete="off" required>
