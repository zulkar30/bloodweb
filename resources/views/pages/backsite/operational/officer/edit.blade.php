        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Officer</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item">Officer</li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.officer.update", [$officer->id]) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <h4 class="form-section"><i class="fa fa-edit"></i> Form Officer</h4>
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <select name="user_id"
                                                                ...
                                                                @foreach($user as $key => $user_item)
                                                                    <option value="{{ $user_item->id }}" {{ $officer->user_id == $user_item->id ? 'selected' : '' }}>{{ $user_item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="example dentist or dermatology" value="{{ old('name', isset($officer) ? $officer->name : '') }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="birth_place" name="birth_place"
                                                                ...
                                                                value="{{ old('birth_place', isset($officer) ? $officer->birth_place : '') }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="date" id="birth_date" name="birth_date"
                                                                class="form-control" value="{{ old('birth_date', isset($officer) ? $officer->birth_date : '') }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <select name="gender" id="gender" class="form-control select2"
                                                                required>
                                                                <option value="{{ old('gender', isset($officer) ? $officer->gender : '') }}" disabled selected>
                                                                    @if ($officer->gender ==1)
                                                                        <span>Laki-laki</span>
                                                                    @else
                                                                        <span>Perempuan</span>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="contact" name="contact"
                                                                class="form-control" value="{{ old('contact', isset($officer) ? $officer->contact : '') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="address" name="address"
                                                                class="form-control" value="{{ old('address', isset($officer) ? $officer->address : '') }}"
                                                                autocomplete="off"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="age" name="age"
                                                                class="form-control" value="{{ old('age', isset($officer) ? $officer->age : '') }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <select name="blood_type_id" id="blood_type_id"
                                                                class="form-control select2" required>
                                                                <option value="{{ old('blood_type_id', isset($officer) ? $officer->blood_type_id : '') }}" disabled selected>{{ $officer->blood_type->name }}
                                                                </option>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <select name="position_id" id="position_id"
                                                                class="form-control select2" required>
                                                                <option value="{{ old('position_id', isset($officer) ? $officer->position_id : '') }}" disabled selected>{{ $officer->position->name }}
                                                                </option>
                                                ...
                                                <div class="form-actions text-right">
                                                    <a href="{{ route('backsite.officer.index') }}" style="width:120px;" class="btn bg-blue-grey text-white mr-1" onclick="return confirm('Are you sure want to close this page? , Any changes you make will not be saved.')">
