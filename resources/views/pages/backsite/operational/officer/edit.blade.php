                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.officer.update', [$officer->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="user_id" id="user_id" class="form-control select2"
                                                            required>
                                                            <option value="{{ '' }}" disabled selected>Pilih Akun User
                                                            </option>
                                                            @foreach ($user as $key => $user_item)
                                                                <option value="{{ $user_item->id }}"
                                                                    {{ $officer->user_id == $user_item->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            ...
                                                            value="{{ old('name', isset($officer) ? $officer->name : '') }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="gender" id="gender" class="form-control select2"
                                                            required>
                                                            <option
                                                                value="{{ old('gender', isset($officer) ? $officer->gender : '') }}"
                                                                disabled selected>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="birth_place" name="birth_place"
                                                            ...
                                                            value="{{ old('birth_place', isset($officer) ? $officer->birth_place : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="date" id="birth_date" name="birth_date"
                                                            class="form-control"
                                                            value="{{ old('birth_date', isset($officer) ? $officer->birth_date : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="address" name="address"
                                                            class="form-control"
                                                            value="{{ old('address', isset($officer) ? $officer->address : '') }}"
                                                            autocomplete="off"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="contact" name="contact"
                                                            class="form-control"
                                                            value="{{ old('contact', isset($officer) ? $officer->contact : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="age" name="age"
                                                            class="form-control"
                                                            value="{{ old('age', isset($officer) ? $officer->age . ' Tahun' : '') }}"
                                                ...
                                                <div
                                                    ...
                                                    <label class="col-md-3 label-control">Gologan Darah <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="blood_type_id" id="blood_type_id"
                                                            class="form-control select2" required>
                                                            <option
                                                                value="{{ old('blood_type_id', isset($officer) ? $officer->blood_type_id : '') }}"
                                                                disabled selected>{{ $officer->blood_type->name }}
                                                            </option>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="position_id" id="position_id"
                                                            class="form-control select2" required>
                                                            <option
                                                                value="{{ old('position_id', isset($officer) ? $officer->position_id : '') }}"
                                                                disabled selected>{{ $officer->position->name }}
                                                            </option>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.officer.index') }}" style="width:120px;"
