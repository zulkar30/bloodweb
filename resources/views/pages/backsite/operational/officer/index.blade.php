        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Officer</h3>
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('officer_edit')
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.officer.edit', $officer_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @can('officer_delete')
                                                                                <form
                                                                                    action="{{ route('backsite.officer.destroy', $officer_item->id) }}"
                                                                                    method="POST"
