    ...
    <div class="min-h-screen flex justify-center items-center pt-20 py-28">
        <div class="mx-auto text-center">
            <img
                ...
                class="inline-block"
                alt="Blood Request success ilustration"
            />
            <div class="mt-12">
                <h2 class="text-[#1E2B4F] text-2xl font-semibold">Pengajuan Berhasil</h2>
                <p class="text-[#AFAEC3] mt-4">Silahkan Datang ke UTD RSUD Bengkalis dengan membawa bukti untuk konfirmasi selanjutnya</p>
